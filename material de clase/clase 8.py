...
df1 = df[df["ethnicity"]==1] # mujeres con hasta 28 años de edad
df2 = df[df["ethnicity"]==0]# mujeres con más de 28 años de edad
...
#%% Supongamos que vamos a comparar la presión sistolica de estos dos grupos 
"""se deben realizar pruebas de normalidad 
"""
